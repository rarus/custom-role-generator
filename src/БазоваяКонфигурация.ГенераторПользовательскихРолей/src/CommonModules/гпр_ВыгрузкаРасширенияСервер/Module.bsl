...
Функция ОбновлениеРасширение() Экспорт
	...
	ЗапуститьПриложение(
		КомандаЗагрузкиРасширенияВБазу(
	...
	ЗапуститьПриложение(
		КомандаВыгрузкиРасширенияИзБазы(
			ВременныйКаталогБазы,
			ИмяРасширения,
			ИспользоватьПромежуточнуюБазу),,
		Истина,
...
Функция КомандаЗагрузкиРасширенияВБазу(КаталогБазы, ИмяРасширения, ИспользоватьПустуюБазу = Истина)
...
Функция КомандаВыгрузкиРасширенияИзБазы(КаталогБазы, ИмяРасширения, ИспользоватьПустуюБазу = Истина)
