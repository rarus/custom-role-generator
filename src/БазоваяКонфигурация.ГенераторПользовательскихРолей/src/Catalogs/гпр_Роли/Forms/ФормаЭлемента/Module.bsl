...
Процедура НачатьДобавлениеОбъекта()
	...
	Иначе
		ДанныеТекущегоОбъекта = Новый Структура("ВидОбъекта, ИмяОбъекта");
		ЗаполнитьЗначенияСвойств(ДанныеТекущегоОбъекта, ТекущиеДанные);
	КонецЕсли;
	ОписаниеОповещенияДобавлениеОбъекта = Новый ОписаниеОповещения("ДобавлениеОбъектаЗавершение", ЭтотОбъект);
	
	ПараметрыОткрытия = Новый Структура;
	ПараметрыОткрытия.Вставить("УжеВыбранныеОбъекты", ОбъектыВДереве(ОбъектыВДереве)); 
	ПараметрыОткрытия.Вставить("ДанныеТекущегоОбъекта", ДанныеТекущегоОбъекта);
